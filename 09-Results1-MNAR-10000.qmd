---
title: "Results under MNAR for N=10,000"
---
...
# Data
load("MNAR_10000_Combined_Long_03Oct2024.Rdata")
load("MNAR_10000_Combined_03Oct2024.Rdata")
# Number of NAs
...
The CCA had the lowest (better accuracy) across all scenarios with the biggest difference at higher prevalences (5% and 10%) and higher missingness (50% and 75%), @fig-brier_score.

```{r #fig-brier}
#| label: brier_score
#| echo: false
#| fig-cap: Brier Score for each combination of prevalence at n=10,000 under Missing Not at Random
#| fig-width: 10
#| fig-height: 12 
...
ggplot(simulation_parameters_long %>% filter(Measure=="Brier Score"), 
  ...
  geom_point(data = combined_df, aes(x = Brier, y = Method), 
             shape =4, position = position_jitter(width = 0.002), alpha = 0.5) + 
    labs(y = NULL,
         x = NULL,
         colour = "Method\n(Mean, 95% CI)") +
    theme_minimal() + 
...
#| label: auc
#| echo: false
#| fig-cap: AUC for each combination of prevalence at n=10,000 under under Missing Not at Random
#| fig-width: 10
#| fig-height: 12 
...
#| label: calitl
#| echo: false
#| fig-cap: Calibration in the Large for each combination of prevalence at n=10,000 under Missing not at Random
#| fig-width: 10
#| fig-height: 12 
...
#| label: calslope
#| echo: false
#| fig-cap: Calibration Slope for each combination of prevalence at n=10,000 under Missing not at Random
#| fig-width: 10
#| fig-height: 12 
...
#| label: bias
#| echo: false
#| fig-cap: Bias for each combination of prevalence at n=10,000 under Missing not at Random
#| fig-width: 10
#| fig-height: 12 
...
#| label: rmse
#| echo: false
#| fig-cap: RMSE for each combination of prevalence at n=10,000 under Missing not at Random
#| fig-width: 10
#| fig-height: 12 
...
Below, @tbl-results_mnar10000 summarises the Performance Measures under N=100,000.

```{r, echo=FALSE}
#| label: tbl-results_mnar10000
