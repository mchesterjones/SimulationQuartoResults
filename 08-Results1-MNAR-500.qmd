...
# Data
load("MNAR_500_Combined_Long_18Sep2024.Rdata")
load("MNAR_500_Combined_18Sep2024.Rdata")
...
At the smallest sample size, n=500. There were convergence issues where the outcome prevalence was lower (1% and 5%) and where Complete Case Analysis was used to handle the missing data as the sample size was reduced further. At missingness of 75%, more than half the simulations at 1% prevalence were unable to calculate the discrimination (AUC) (55%), calibration intercept (55%) and slope (57%). This is broken down in @tbl-results_mnar500 at the end of the page.
...
The highest average discrimination was associated with higher outcome prevalences at 5% and 10%. Wide confidence intervals were observed for CCA and 1% outcome prevalence where more than half the simulations did not converge. This was also observed under the highest amount of missingness (75%).
