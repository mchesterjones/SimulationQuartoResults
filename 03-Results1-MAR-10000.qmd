...
########################
load("MAR_10000_Combined_Long_29Aug2024.Rdata")
```

### Predictive Performance from Study 1 N=10,000 under Missing at Random {#-predictive-performance-mar-10000}
Table 2 summarises the performance measures under N=10,000. 
```{r}
# table of results
  table_results10000 <- simulation_parameters_long %>% 
        select(Parameter,"Method", "Measure", "AVG", "LCI", "UCI", "NACount") %>%
        mutate(across(c(AVG, LCI, UCI),  ~ round(.x, 4)))
   
  ## quick table 
  ft_results <- flextable(table_results10000) %>%
     set_caption(caption = "Table 2: Performance Measures at N=10,000 under MAR")
  

```

```{r}
#| label: open_datasets_n10000 
#| include: false
## Set working directory 
setwd("C:\\Users\\maecj\\OneDrive - Nexus365\\A DPhil\\Simulation studies\\Programs\\Study 1\\SimulationStudy1_11Jun2024\\SimulationStudy\\Data") 
