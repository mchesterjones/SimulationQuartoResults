...
## Predictive Performance from Study 1 N=100,000 under Missing at Random {#-predictive-performance-mar100000}
...
ggplot(simulation_parameters_long %>% filter(Measure=="Brier Score"), 
  ...
  geom_point(data = combined_df, aes(x = Brier, y = Method),              
             shape =4, position = position_jitter(width = 0.006), alpha = 0.5) + 
    labs(y = NULL,
         x = NULL,
         colour = "Method\n(Mean, 95% CI)") +
    theme_minimal() + 
