---
title: "Results for MAR N=100,000"
---
...
```{r}
#| label: open_datasets_mar_100000 
#| include: false
...
########################
load("MAR_100000_Combined_Long_30Aug2024.Rdata")
```

### Predictive Performance from Study 1 N=100,000 under Missing at Random {#-redictive-performance-n500}
...
# table of results
  ...
  ft_results <- flextable(table_results) %>%
     set_caption(caption = "Table 3: Performance Measures at N=100,000 under MAR")
```
